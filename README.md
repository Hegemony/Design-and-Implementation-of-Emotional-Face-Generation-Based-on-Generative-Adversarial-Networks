...
## Use Own Datasets
- Obtain AUs Vector: Use [OpenFace](https://github.com/TadasBaltrusaitis/OpenFace) to extract Action Units vectors from the cropped face. Specifically, only the AUs intensity is used in this project, namely
