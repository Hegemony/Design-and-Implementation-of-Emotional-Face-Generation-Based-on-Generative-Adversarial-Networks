...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--plot_losses_freq', type=int, default=300, help='plot log every plot_freq step.')
        parser.add_argument('--sample_img_freq', type=int, default=2000, help='draw image every sample_img_freq step.')


        parser.add_argument('--save_epoch_freq', type=int, default=10, help='save checkpoint every save_epoch_freq epoch.')
