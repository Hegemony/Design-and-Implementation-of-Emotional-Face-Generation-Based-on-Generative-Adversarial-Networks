...
class RaFDDataset(BaseDataset):
    """docstring for RaFDDataset"""

    def __init__(self):
        super(RaFDDataset, self).__init__()

    def initialize(self, opt):
        super(RaFDDataset, self).initialize(opt)
    ...
    def make_dataset(self):
        ...
        with open(self.imgs_name_file, 'r') as f:
            lines = f.readlines()
            imgs_path = [os.path.join(self.imgs_dir, line.strip()) for line in
                         lines]
